...
const ALL_MEMBERS = [
  ...
  { id: 'f4', teamId: 'football', clubId: 'bayern', name: 'Leroy Sané', role: 'Player', position: 'Winger', birthdate: '1996-01-11', avatar: 'https://img.a.transfermarkt.technology/portrait/header/192565-1711617235.jpg', availability: 'available', attendance: 91 },
  { id: 'f5', teamId: 'football', clubId: 'bayern', name: 'Joshua Kimmich', role: 'Player', position: 'Defensive Midfield', birthdate: '1995-02-08', avatar: 'https://img.a.transfermarkt.technology/portrait/header/161056-1711617196.jpg', availability: 'available', attendance: 99 },
  { id: 'f6', teamId: 'football', clubId: 'bayern', name: 'Leon Goretzka', role: 'Player', position: 'Central Midfield', birthdate: '1995-02-06', avatar: 'https://img.a.transfermarkt.technology/portrait/header/261025-1711617180.jpg', availability: 'available', attendance: 94 },
  { id: 'f7', teamId: 'football', clubId: 'bayern', name: 'Alphonso Davies', role: 'Player', position: 'Left Back', birthdate: '2000-11-02', avatar: 'https://img.a.transfermarkt.technology/portrait/header/424204-1711617144.jpg', availability: 'available', attendance: 93 },
  { id: 'f8', teamId: 'football', clubId: 'bayern', name: 'Min-jae Kim', role: 'Player', position: 'Centre Back', birthdate: '1996-11-15', avatar: 'https://img.a.transfermarkt.technology/portrait/header/503446-1711617208.jpg', availability: 'available', attendance: 95 },
  { id: 'f9', teamId: 'football', clubId: 'bayern', name: 'Dayot Upamecano', role: 'Player', position: 'Centre Back', birthdate: '1998-10-27', avatar: 'https://img.a.transfermarkt.technology/portrait/header/344695-1711617247.jpg', availability: 'available', attendance: 92 },
  { id: 'f10', teamId: 'football', clubId: 'bayern', name: 'Manuel Neuer', role: 'Player', position: 'Goalkeeper', birthdate: '1986-03-27', avatar: 'https://img.a.transfermarkt.technology/portrait/header/17259-1711617260.jpg', availability: 'available', attendance: 97 },
